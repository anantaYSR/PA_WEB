...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <nav>
                <a href="form.php"><i class="material-icons">assignment_returned</i><font size="3">FORM</font></a>
                <a href="update.php?id=<?=$row['id']?>"><i class="material-icons">cached</i><font size="3">UBAH</font></a>
                <a href="../logout.php"><i class="material-icons">logout</i><font size="3">LOGOUT</font></a>
            </nav>
